 ...
 */
public class Login_form_removeproductFXMLController implements Initializable {
          ...
          DataAccessLayer dal = new DataAccessLayer();
            ...
            while(rs.next()){
                ...
                notif.setText("INCORRECT USERNAME OR PASSWORD");    
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("remove_product_functionFXML.fxml"));
